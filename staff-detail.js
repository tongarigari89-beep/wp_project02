...
const relatedStaff = [
    {image:"./img/syain02.jpg",name:"橋本 拓也",message01:"全力で考えぬける環境",message02:"試練の数だけ強くなれました",position:"コンサルタント",joined:"2015年入社"},
    {image:"./img/syain03.jpg",name:"青木 美月",message01:"お客様も知らない課題を",message02:"一緒に探し出す醍醐味",position:"ソリューション営業",joined:"2017年入社"},
    {image:"./img/syain04.jpg",name:"高橋 智",message01:"ビジネスの課題を",message02:"データで解決する醍醐味",position:"データサイエンティスト",joined:"2002年入社"},
    {image:"./img/syain05.jpg",name:"高田 凛",message01:"どんな難解な案件も",message02:"チームで突破できる強い連携",position:"コンサルタント",joined:"2006年入社"},
    {image:"./img/syain06.jpg",name:"橘 光",message01:"お客様と一緒に開発",message02:"豊富なプライム案件が魅力です",position:"システム事業部課長",joined:"2007年入社"}
];

const shuffledStaff = [...relatedStaff].sort(() => Math.random() - 0.5).slice(0,3);
